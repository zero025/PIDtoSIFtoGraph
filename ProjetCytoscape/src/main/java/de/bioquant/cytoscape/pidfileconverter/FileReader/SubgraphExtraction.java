...
public class SubgraphExtraction
{
	...
	public void readGeneSourceFile()
	{
		if(!inputgenesourcefilepath.trim().equals(""))
		{
			...
			catch (IOException e)
			{
				JOptionPane
	    		.showMessageDialog(new JFrame(),
	    				"Please check the gene source file! Click ? for help.",
	...
	/**
	 * This method reads the gene target file and
	 * checks if the input nodes are present in the cynodelist.
	 * if they are present, check if the node comes from a translation event.
	 * If yes, check if it is a protein family or complex,
	 * if no, then add it into the arraylist cytotargetsubgraph
	 */
	...
	/**
	 * This method reads the file and checks if the checkbox is ticked.
	 * If yes, the method will search also in protein families and complexes.
	 * If no, the method will only search for nodes of proteins.
	 * In both ways, the method adds positive searches into the cytosourcesubgraph arraylist.
	 */
	 ...
	 * If yes, the method will search also in protein families and complexes.
	 * If no, the method will only search for nodes of proteins.
	 * In both ways, the method adds positive searches into the cytotargetsubgraph arraylist.
	 */
	...
	/**
	 * Method reads the arraylist of IDs and draws the subgraph using the shortest path method.
	 * Checks both cytosourcesubgraph and cytotargetsubgraph for a shortest path between
	...
	/**
	 * This method checks the sif and the nodetype.na files to see if the node is present,
	 * and if the node origins from a transcription event
	 * @param nodename the node of interest
	 * @param sifpath the sif file
	 * @param nodetypefilepath the nodetype.na file
	 * @return
	 * @throws IOException
	 */
	...
	/**
	 * This method checks if the node is of type transcription
	 * by checking the nodetype.na file and returns true if so.
	 * @param precursornode the node of interest
	 * @param nodetypefilepath the path of the nodetype.na file
	 ...
	 * @param node the CyNode object to be coloured
	 * @param nodecolourRGB the RGB code of the colour, e.g. "255,0,0" for red
	 */
