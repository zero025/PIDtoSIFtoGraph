...
/**
 * This class represents one EntrezGene ID. It handles also the part molecules
...
public class EntrezGeneID {
	...
	/**
	 * Creates a new EntrezGene ID object with specified EntrezGene ID. For part
	 ...
	 */
	public EntrezGeneID(String entrezGeneID, boolean partmolecule)
				throws InvalidArgumentException {
